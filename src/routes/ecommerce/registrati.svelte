...
<div class="uk-card uk-card-default uk-card-body uk-width-1-2@m forma" >
    ...
    <fieldset class="uk-fieldset">
        ...
        <div class="uk-margin">
            <input id="password2" class="uk-input" type="password" placeholder="Conferma la Password" bind:value={passcheck}>
        </div>
        <div class="uk-margin">
            <input id="password2" class="uk-input" type="text" placeholder="Numero di telefono" bind:value={tel}>
        </div>
        <div class="uk-margin">
            <input id="password2" class="uk-input" type="date" placeholder="Data di nascita" bind:value={nascita}>
        </div>
        <div class="uk-margin">
