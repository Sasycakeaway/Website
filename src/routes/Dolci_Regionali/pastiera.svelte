<script>
  ...
  <h1>&nbsp;</h1>
  <h1 class="tit">Pastiera Napoletana</h1>
  <h1>&nbsp;</h1>
  <div class="" align="center">
    <div class="uk-card uk-card-default" id="card">
      <hr />
      <img src="/images/Pastiera Napoletana.jpg"  alt="" class="imgcenter"> 
      <div>
    ...
    <h1>&nbsp;</h1>
    <button class="uk-button uk-button-primary carbut" id="Pastiera Napoletana" on:click={(event) => biscotti(event)}>Aggiungi al carrello</button>
    <h1>&nbsp;</h1>
