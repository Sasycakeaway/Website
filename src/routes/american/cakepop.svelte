...
import Info from '/static/components/info.svelte';
    ...
    <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
        <div class="uk-card-media-left uk-cover-container">
            <img src="/images/cakepop.jpg"  alt="" uk-cover>
            <canvas width="600" height="400"></canvas>
        </div>
        <div>
            <div class="uk-card-body">

                <p class="det" >Avete mai pensato di mangiare una torta a forma di gelato o di lecca lecca? Allora non avete mai visto un cake pop. Dolcetto sfizioso e divertente glassato di cioccolato  e decorato con perline, zuccherini, granelle, ghiaccia reale, semplicemente magnifico.</p>
            </div>
        </div>
    </div>
