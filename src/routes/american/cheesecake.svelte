...
import Info from '/static/components/info.svelte';
    ...
    <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
        <div class="uk-card-media-left uk-cover-container">
            <img src="/images/cheesecake.jpg"  alt="" uk-cover>
            <canvas width="600" height="400"></canvas>
        </div>
        <div>
            <div class="uk-card-body">

                <p class="det" style="color:black;">Nel 1872 un lattaio americano, mr J. L. Kraft, nel tentativo di ricreare il formaggio francese Neufchatel, incidentalmente inventò il  Philadelphia. Questo ingrediente è alla base della cheescake, anche nella versione newyorkese cotta e guarnita di frutta e salse.</p>
            </div>
        </div>
    </div>
