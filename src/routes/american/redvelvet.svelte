...
import Info from '/static/components/info.svelte';
    ...
    <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
        <div class="uk-card-media-left uk-cover-container">
            <img src="/images/redvelvet.jpg"  alt="" uk-cover>
            <canvas width="600" height="400"></canvas>
        </div>
        <div>
            <div class="uk-card-body">

                <p class="det" >Tradotto in italiano torta di velluto rosso.  Questa torta è realizzata a strati di morbido pan di spagna rosso e guarnita con crema alla vaniglia, al burro, frosting al formaggio o panna.  Un candido vestito che nasconde il rosso focoso della passione.</p>
            </div>
        </div>
    </div>
