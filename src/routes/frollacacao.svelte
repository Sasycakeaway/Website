...
import Info from '/static/components/info.svelte';
    ...
    <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
        <div class="uk-card-media-left uk-cover-container">
            <img src="/images/cropan.webp"  alt="" uk-cover>
            <canvas width="600" height="400"></canvas>
        </div>
        <div>
            <div class="uk-card-body">

                <p class="det" style="color:black;">Un connubio di sapori particolare e ricercato: panna cotta tradizionale o al caffè per una tartelletta moderna dal sapore unico.</p>
            </div>
        </div>
    </div>
