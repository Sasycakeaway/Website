<div class="tot">
    <div class="uk-grid-column-small uk-grid-row-large uk-child-width-1-3@s uk-text-center" uk-grid>
        <div>
            <div>
                <div class="uk-card uk-card-default" style="background-color: #b96563;">
                    ...
                    <div class="uk-card-media-bottom">
                        <img src="images/meliga.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <div >
                <div class="uk-card uk-card-default" style="background-color: #b96563;">
                <div class="uk-card-body">
                    <a href="/biscotti/brut"><h3 class="uk-card-title">Brüt ma Bon</h3></a>
                    <p>Alla fine dell'800 a Borgomanero venne sfornato un dolce davvero brutto da vedere (brüt) ma buonissimo nel gusto (bon). Il mio? meraviglioso!</p>
                </div>
                <div class="uk-card-media-bottom">
                    <img src="images/brut.jpeg"  alt="">
                </div>
            </div>
        </div>
        </div>
        <div>
            <div >
                <div class="uk-card uk-card-default" style="background-color: #b96563;">
                    <div class="uk-card-body">
                        <a href="/biscotti/meringhe"><h3 class="uk-card-title">Meringhe</h3></a>
                    ...
                    <div class="uk-card-media-bottom">
                        <img src="images/meringa.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div>
                <div class="uk-card uk-card-default" style="background-color: #b96563;">
                    ...
                    <div class="uk-card-media-bottom">
                        <img class="acc" src="images/nocciolotti.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div>
                <div class="uk-card uk-card-default" style="background-color: #b96563;">
                    <div class="uk-card-body">
                        <a href="/tartfrolla"><h3 class="uk-card-title">Cantuccini</h3></a>
                        <p>La storia di questi dolci secchi alle mandorle è antichissima: già i soldati romani mangiavano una specie di pane dolce, aromatizzato all’anice o al finocchio cotto al forno, tagliato in maniera obliqua a metà cottura e rimesso in forno a biscottare (cioè a cuocere due volte per mantenere una conservazione più lunga). Così oggi possiamo gustare una vera e propria delizia da annegare nel Vin Santo.</p>
                    </div>
                    <div class="uk-card-media-bottom">
                        <img src="images/cantucci.jpeg" class="acc" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div>
                <div class="uk-card uk-card-default" style="background-color: #b96563;">
                    <div class="uk-card-body">
                        <a href="/biscotti/canestrelli"><h3 class="uk-card-title">Canestrelli</h3></a>
                        <p>Dalla tipica forma a margherita, si offrono a fine pasto , ma anche durante il pomeriggio insieme ad una fumante tazza di cioccolata calda o di tè.</p>
                    </div>
                    <div class="uk-card-media-bottom">
                        <img class="acc" src="images/canestrelli.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <div>
                <div class="uk-card uk-card-default" style="background-color: #b96563;">
                    <div class="uk-card-body">
                        <a href="/biscotti/assabesi"><h3 class="uk-card-title">Assabesi</h3></a>
                    ...
                    <div class="uk-card-media-bottom">
                        <img class="acc" src="images/assabesi.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div>
                <div class="uk-card uk-card-default" style="background-color: #b96563;">
                    <div class="uk-card-body">
                        <a href="/tartfrolla"><h3 class="uk-card-title">Krumiri</h3></a>
                        <p>Nati nel 1878, quando l’Italia era ormai unita, sono ispirati ai famosi mustacchi di re Vittorio Emanuele II e nel tempo sono diventati sempre più noti e apprezzati. Dolce tipico di Casale Monferrato, inventati da Domenico Rossi sono un prodotto d'eccellenza piemontese. Mi sono cimentata anche io in questa ricetta golosa. Il risultato è interessante.</p>
                    </div>
                    <div class="uk-card-media-bottom">
        ...
        <div>
            <div>
                <div class="uk-card uk-card-default" style="background-color: #b96563;">
                    <div class="uk-card-body">
                        <a href="/tartfrolla"><h3 class="uk-card-title">Diamanti al cacao</h3></a>
