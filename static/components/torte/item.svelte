    ...
    <div class="uk-grid-column-small uk-grid-row-large uk-child-width-1-3@s uk-text-center" uk-grid>
            ...
            <div>
                <div class="uk-card uk-card-default" uk-height-viewport="expand: true;min-height: 600">
                    <div class="uk-card-body">
                        <a href="/biscotti/meliga"><h3 class="uk-card-title">Torte classiche e moderne decorate</h3></a>
            ...
            <div >
                <div class="uk-card uk-card-default" uk-height-viewport="expand: true;min-height: 600">
                    <div class="uk-card-body">
                        ...
                        <p>Sono le classiche torte della nonna, come da tradizione, senza aggiunta di creme o cose che possano deperire. Tuffati nel passato con la crostata, il ciambellone la torte di nocciole, la sbrisolona, le torte allo yogurth, la tenerina, la caprese....e quante altre ne desideri.</p>
        ...
        <div>
            <div>
                <div class="uk-card uk-card-default" uk-height-viewport="expand: true;min-height: 600">
                    <div class="uk-card-body">
                        <a href="/torte/meringata"><h3 class="uk-card-title">Torta Meringata</h3></a>
                        <p>Un grande classico, il re dei semifeddi. Con gocce di cioccolato, con marron glacé, con frutti di bosco o con le fragole, nessuno saprà resistere alla sua dolcezza.</p>
                    </div>
                    <div class="uk-card-media-bottom">
            ...
            <div>
                <div class="uk-card uk-card-default" uk-height-viewport="expand: true;min-height: 600">
                    <div class="uk-card-body">
                        ...
                        <p>Hai una ricorrenza particolare da festeggiare, un compleanno speciale, un battesimo, una comunione o un matrimonio? Puoi prenotare la tua creazione da Sasy's. Insieme renderemo questo evento unico e irripetibile.</p>
                    </div>
                    <div class="uk-card-media-bottom">
